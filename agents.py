...
class CloneAgent():
    ...
    def check_against_traindata(self, path_agent, args):
        ...
        fig, ax = plt.subplots(1, n_actions + 1, figsize=(12, 4))
        fig.suptitle('Performance on training data & training loss', fontsize=16)
        ...
        fig_name = 'TrainingPerf_bc_' + str(args.env_name) + '_nepochs=' + str(args.n_epochs) + '_lr=' \
